package com.zbf.iceseal.tag.id3;
...
public class ID3Wrapper {
	...
	public ID3Wrapper(Mp3File mp3File) {
	...
	public ID3Wrapper(String filePath) throws UnsupportedTagException, InvalidDataException, IOException {
	...
	public ID3Wrapper(String filePath, boolean scanFile) throws UnsupportedTagException, InvalidDataException, IOException {
		Mp3File mp3File = new Mp3File(filePath, scanFile);
		if(mp3File.hasId3v1Tag()) {
			this.id3v1Tag = mp3File.getId3v1Tag();
		}
		if(mp3File.hasId3v2Tag()) {
	...
	public ID3Wrapper(String filePath, int bufferLength) throws UnsupportedTagException, InvalidDataException, IOException {
		Mp3File mp3File = new Mp3File(filePath, bufferLength);
		if(mp3File.hasId3v1Tag()) {
			this.id3v1Tag = mp3File.getId3v1Tag();
		}
		if(mp3File.hasId3v2Tag()) {
	...
	public ID3Wrapper(String filePath, int bufferLength, boolean scanFile) throws UnsupportedTagException, InvalidDataException, IOException {
		Mp3File mp3File = new Mp3File(filePath, bufferLength, scanFile);
		if(mp3File.hasId3v1Tag()) {
			this.id3v1Tag = mp3File.getId3v1Tag();
		}
		if(mp3File.hasId3v2Tag()) {
